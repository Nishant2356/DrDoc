                ...
                {isGenerating ? (
                  ...
                  <div className="w-full h-full text-left flex flex-col">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button onClick={() => setGeneratedNote("")} className="text-xs text-blue-600 font-medium hover:underline">Start New</button>
                    </div>
                    <div className="bg-white p-4 rounded-xl border border-slate-200 whitespace-pre-wrap text-sm text-slate-700 h-[220px] overflow-y-auto mb-4">
                      {generatedNote}
                    </div>
